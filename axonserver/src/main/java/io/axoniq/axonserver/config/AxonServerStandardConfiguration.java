...
public class AxonServerStandardConfiguration {
    private static final Logger LOGGER = LoggerFactory.getLogger(AxonServerStandardConfiguration.class);
    ...
    ApplicationEventMulticaster applicationEventMulticaster() {
        ...
        multicaster.setErrorHandler(ex -> LOGGER.warn("Unexpected error in event handler.", ex));
        return multicaster;
    }
}
